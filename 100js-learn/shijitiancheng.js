function param(data, acount, password) {
    var biRadixBase = 2;
    var biRadixBits = 16;
    ...
    function FCQ(data, acount, password) {
        var fcq = "id=" + acount + "&pw=" + encodeURIComponent(password) + "&mt="+ "&lt=" + 0;
        setMaxDigits(129);
        var key = new RSAKeyPair(data.pm, "", data.pk);
        var encrypted = encryptedString(key, fcq);
        return encrypted.toString()
    }
    return FCQ(data, acount, password)
}
console.log(param({pk: "",
    pm: "010001"},"13612345678","123456789").length)