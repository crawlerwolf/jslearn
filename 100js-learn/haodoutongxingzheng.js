/*扣取js*/
// var ARRAY_BUFFER = true, HEX_CHARS = "0123456789abcdef".split(""), EXTRA = [128, 32768, 8388608, -2147483648], SHIFT = [0, 8, 16, 24], OUTPUT_TYPES = ["hex", "array", "digest", "buffer", "arrayBuffer", "base64"], BASE64_ENCODE_CHAR = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split(""), blocks = [], buffer8;
//
// if (ARRAY_BUFFER) {
...
//     };
// pwd = new Md5(!0).update("123456789")["hex"]()
// console.log(pwd)
...
var result = md5.update('123456789').digest('hex');
console.log(result)