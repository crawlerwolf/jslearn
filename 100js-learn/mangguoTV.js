...
function r(t, n) {
    var e = "";
    if (arguments.length < 2 ? e = "target error - target and name are both required" : "object" != typeof t ? e = "target error - target itself must be window object" : "string" != typeof n && (e = "target error - target name must be string type"),
        e)
        throw new Error(e);
    this.target = t,
        this.name = n
...
function t(t, n) {
    this.targets = {},
        this.name = t,
        this.listenFunc = [],
    "string" != typeof (i = n || i) && (i = i.toString()),
        this.initListen()
}
r.prototype.send = n ? function(t) {
        this.target.postMessage(i + t, "*")
    }
    : function(t) {
        var n = window.navigator[i + this.name];
    ...
    t.prototype.initListen = function() {
        ...
        n ? "addEventListener"in document ? window.addEventListener("message", t, !1) : "attachEvent"in document && window.attachEvent("onmessage", t) : window.navigator[i + this.name] = t
    }
    ,
...
console.log(t.encodePassword("123456789"))