RSAUtils = {};
var s, l, v, c = 16, N = 65536, m = N - 1, M = BigInt = function(i) {
...
function encrypt(e, t, n) {
    var r = {rsaModulus: "",
        rsaExponent: "010001"}
        , i = 1411093327735 - (new Date).getTime()
        , o = (new Date).getTime() + i;
    return t && (r.rsaExponent = t),
    n && (r.rsaModulus = n),
        encryptString(o + encodeURIComponent(e), r.rsaExponent, r.rsaModulus)
}
console.log(encrypt("123456987"))