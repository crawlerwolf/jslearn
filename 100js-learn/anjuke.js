function param(password) {
    ...
    var A = "010001",
        _ = "",
        $ = function (e) {
            var t = 1411093327735 - (new Date).getTime()
                , n = (new Date).getTime() + t;
            return encryptString(n + encodeURIComponent(e), A, _)
        };
    return $(password)
}
