...
function sp(servertime, nonce, pwd){
    var f = new RSAKey();
    f.setPublic("",
        "10001");
    var result = f.encrypt([parseInt(servertime), nonce].join("\t") + "\n" + pwd)
    return result
}
function su(username){
    ...
    var result = base64.encode(username);
    return result
}
